...
png("plots/treemaps/2-2-2_1835_v2.png", height = 650, width = 650)
...
```{r}
png("plots/treemaps/2-2-2_1836_v2.png", height = 600, width = 600)
...
for (i in 1:(length(unique(per_full$year))-1)) {
  year1 <- unique(per_full$year)[i]
  year2 <- year1+1
