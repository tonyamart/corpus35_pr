...
edges_intersection <- intersect(stable_edges_i4_m, stable_edges_i4_n)
...
```{r}
net_comp <- graph_from_data_frame(d = edgelist_i4, vertices = nodelist_ns, directed = F)
net_comp

network_compare(net_comp, "iamb_4", c(wes_palette("Darjeeling1")[2], wes_palette("Royal1")[1]))
```
